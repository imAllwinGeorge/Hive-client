    ...
    <div className="min-h-screen flex items-center justify-center p-4  from-blue-200 via-blue-100 to-blue-50">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Create Account</h3>
          <p className="text-gray-600 text-sm md:text-base">Join us today to get started</p>
        </div>
        ...
        {/* <div className="grid grid-cols-3 gap-3">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#1F2937">
